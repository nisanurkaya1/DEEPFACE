...
plt.title('Epoch vs. Kayıp (Loss) — Full Frame', fontsize=14)
plt.xlabel('Epoch')
plt.ylabel('Kayıp')
plt.legend()
...
plt.title('Epoch vs. Doğruluk (Accuracy) — Full Frame', fontsize=14)
plt.xlabel('Epoch')
plt.ylabel('Doğruluk')
plt.legend()
plt.grid(True, alpha=0.3)
...
plt.title('Epoch vs. AUC — Full Frame', fontsize=14)
plt.xlabel('Epoch')
plt.ylabel('AUC')
plt.legend()
plt.grid(True, alpha=0.3)
